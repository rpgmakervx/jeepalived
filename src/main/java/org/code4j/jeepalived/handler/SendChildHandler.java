 ...
 * 00:59
 */
public class SendChildHandler extends ChannelInitializer<SocketChannel> {
    @Override
    protected void initChannel(SocketChannel socketChannel) throws Exception {
        ChannelPipeline pipeline = socketChannel.pipeline();
        pipeline.addLast("ping_handler", new IdleStateHandler(Config.getIntValue(Config.READ_SECOND),
                Config.getIntValue(Config.WRITE_SECOND),Config.getIntValue(Config.READ_WRITE_SECOND)));
        // 字符串解码 和 编码
